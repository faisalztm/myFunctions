...
class Display {
	...
	static function Ban($title, $versi, $server = 0){
        ...
        print m." |   _   |       |   Y   |  ".h."Create By ".k.": ".p."ZTM PEKIQ".n;
        print m." |___|   |.|   | |.      |  ".h."Script    ".k.": ".p.$title.n;
        print m."  /  ___/`-|.  |-|. \_/  |  ".h."Group     ".k.": ".p."t.me/ztmpekiq".n;
	...
	static function ipApi(){
        ...
        static function Gas($str){
          ...
          print $rt;
          usleep(2500);}}
	static function User($label, $msg = "[No Content]"){$len = 9;$lenstr = $len-strlen($label);print h."🙎 ".$label.mcerah.str_repeat(" ",$lenstr)."= ".p.$msg.n;}
...
class Captcha {
	...
	public function __construct(){
		...
		if(Functions::getConfig("type") == 1){
			...
			Display::Cetak("Register","t.me/Xevil_check_bot?start=5933449534");
